...
/* joins: find the product name, total # sold, and total price sold,
 ...
 SELECT products.Name, SUM(sales.Quantity) AS TOTALSOLD, SUM(sales.PricePerUnit) AS TOTALPRICESOLD
FROM products
...
SELECT employees.FirstName, employees.LastName, employees.EmployeeID, products.Name AS PRODUCTNAME, SUM(sales.Quantity) AS TOTALSALES
FROM sales
INNER JOIN employees ON employees.EmployeeID = sales.EmployeeID
